...
pro.uoffset=[0,0,0,0];
pro.type='aaa';
w100_2=cut_sqw(data_source, pro,[-5,bins,5],[-0.2,0.2],[-0.2,0.2],[-1,bins,max_E],'-nopix','F:\Aman\5mevplots\test\QQplots\110,001 group\plot1.sqw');
...
pro.uoffset=[0,0,0,0];
pro.type='aaa';
w100_3=cut_sqw(data_source, pro,[-5,bins,5],[-0.2,0.2],[-0.2,0.2],[-1,bins,max_E],'-nopix','F:\Aman\5mevplots\test\QQplots\110,001 group\plot1.sqw');
...
pro.uoffset=[0,0,0,0];
pro.type='aaa';
w100_4=cut_sqw(data_source, pro,[-5,bins,5],[-0.2,0.2],[-0.2,0.2],[-1,bins,max_E],'-nopix','F:\Aman\5mevplots\test\QQplots\110,001 group\plot1.sqw');
