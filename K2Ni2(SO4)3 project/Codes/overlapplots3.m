...
a=openfig('F:\Aman\2p8mevplots\test\normalised int vs ene plots\enrg int 2p8 100.fig')
...
legend('integrated plot(0.2-2.8meV)','','Energy:0.2-0.3meV')

hold off

name1=['F:\Aman\2p8mevplots\test\normalised int vs ene plots\comparison inte vs en 100.jpg']
...
a=openfig('F:\Aman\2p8mevplots\test\normalised int vs ene plots\enrg int 2p8 111.fig')
...
name1=['F:\Aman\2p8mevplots\test\normalised int vs ene plots\comparison inte vs en 111.jpg']
...
a=openfig('F:\Aman\5mevplots\test\normalised int vs ene plots\enrg int 5p0 100.fig')
...
legend('integrated plot(0.5-4mev)','','Energy:0.5-0.6meV')
...
a=openfig('F:\Aman\5mevplots\test\normalised int vs ene plots\enrg int 5p0 111.fig')
