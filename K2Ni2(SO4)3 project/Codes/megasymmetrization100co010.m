...
pro.type='aaa';
disp('step0')
w100_1=cut_sqw(data_source,pro,[-2.5,bins,2.5],[-2.5,bins,2.5],[-2.5,bins,2.5],[en_d,bins,en_up],'-nopix');
%plot(w100_1)
%lz 0 12
...
pro.type='aaa';
disp('step1')
w100_2=cut_sqw(data_source, pro,[-2.5,bins,2.5],[-2.5,bins,2.5],[-2.5,bins,2.5],[en_d,bins,en_up],'-nopix');
%plot(w100_2)
%lz 0 12
...
pro.type='aaa';
disp('step2')
w100_3=cut_sqw(data_source, pro,[-2.5,bins,2.5],[-2.5,bins,2.5],[-2.5,bins,2.5],[en_d,bins,en_up],'-nopix');
%plot(w100_3)
%lz 0 12
...
%%
%{
w100_4=cut_sqw(data_source,pro,[-2.5,bins,2.5],[-2.5,bins,2.5],[-2.5,bins,2.5],[0.5,0.7],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot1.sqw');
...
pro.type='aaa';
disp('step0')
w100_11=cut_sqw(data_source,pro,[-3,bins,3],[-3,bins,3],[-3,bins,3],[en_d,bins,en_up],'-nopix');
%plot(w100_1)
%lz 0 12
%saveas(gcf,'F:\Aman\5mevplots\test\QQplots\100,010 group\plot1.jpg')
...
pro.type='aaa';
disp('step1')
w100_22=cut_sqw(data_source, pro,[-3,bins,3],[-3,bins,3],[-3,bins,3],[en_d,bins,en_up],'-nopix');
%plot(w100_2)
%lz 0 12
%saveas(gcf,'F:\Aman\5mevplots\test\QQplots\100,010 group\plot2.jpg')
...
pro.type='aaa';
disp('step2')
w100_33=cut_sqw(data_source, pro,[-3,bins,3],[-3,bins,3],[-3,bins,3],[en_d,bins,en_up],'-nopix');
