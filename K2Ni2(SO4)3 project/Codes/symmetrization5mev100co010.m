...
%data_source='H:\\LET K2Ni2(SO4)3\\sqw_files\\trial.sqw';
...
pro.uoffset=[0,0,0,0];
pro.type='aaa';
w100_1=cut_sqw(data_source,pro,[-8,bins,8],[-8,bins,8],[-0.2,0.2],[en_d,en_up],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot1.sqw');
%plot(w100_1)   
%lz 0 12
...
pro.uoffset=[0,0,0,0];
pro.type='aaa';
w100_2=cut_sqw(data_source, pro,[-8,bins,8],[-8,bins,8],[-0.2,0.2],[en_d,en_up],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot2.sqw');
%plot(w100_2)
%lz 0 12
...
pro.uoffset=[0,0,0,0];
pro.type='aaa';
w100_3=cut_sqw(data_source, pro,[-8,bins,8],[-8,bins,8],[-0.2,0.2],[en_d,en_up],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot3.sqw');
%plot(w100_3)
%lz 0 12
...
%%
%{
w100_4=cut_sqw(data_source,pro,[-8,bins,8],[-8,bins,8],[-0.2,0.2],[0.5,0.7],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot1.sqw');
...
w100_4=cut_sqw(data_source,pro,[-8,bins,8],[-8,bins,8],[-0.2,0.2],[en_d,en_up],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot1.sqw');
w100_4.npix=w100_1.npix+w100_2.npix+w100_3.npix;
...
w100_5=w100_1%cut_sqw(data_source,pro,[-8,bins,8],[-8,bins,8],[-0.2,0.2],[en_d,en_up],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot1.sqw');
...
%y=sum(w100_a.s(size(w100_a.s,2)/2-2:size(w100_a.s,2)/2+2,:),1)
%plot(x,y)
