...
pro.uoffset=[0,0,0,0];
pro.type='rrr';
w100_2=cut_sqw(data_source, pro,bins,bins,[-0.2,0.2],[0.5,0.7],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot1.sqw');
plot(w100_2)
lz 0 12
...
pro.uoffset=[0,0,0,0];
pro.type='rrr';
w100_2=cut_sqw(data_source, pro,bins,bins,[-0.2,0.2],[0.5,0.7],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot2.sqw');
plot(w100_2)
lz 0 12
...
pro.uoffset=[0,0,0,0];
pro.type='rrr';
w100_2=cut_sqw(data_source, pro,bins,bins,[-0.2,0.2],[0.5,0.7],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot3.sqw');
plot(w100_2)
lz 0 12
...
pro.uoffset=[0,0,0,0];
pro.type='rrr';
w100_2=cut_sqw(data_source, pro,bins,bins,[-0.2,0.2],[0.5,0.7],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot4.sqw');
plot(w100_2)
lz 0 12
saveas(gcf,'F:\Aman\5mevplots\test\QQplots\100,010 group\plot4.jpg')

pro.u=[0,0,1];
pro.v=[-1,0,0];
pro.uoffset=[0,0,0,0];
pro.type='rrr';
w100_2=cut_sqw(data_source, pro,bins,bins,[-0.2,0.2],[0.5,0.7],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot5.sqw');
plot(w100_2)
lz 0 12
saveas(gcf,'F:\Aman\5mevplots\test\QQplots\100,010 group\plot5.jpg')

pro.u=[0,-1,0];
pro.v=[0,0,1];
pro.uoffset=[0,0,0,0];
pro.type='rrr';
w100_2=cut_sqw(data_source, pro,bins,bins,[-0.2,0.2],[0.5,0.7],'-nopix','F:\Aman\5mevplots\test\QQplots\100,010 group\plot6.sqw');
plot(w100_2)
lz 0 12
saveas(gcf,'F:\Aman\5mevplots\test\QQplots\100,010 group\plot6.jpg')
